package vn.tunguyen.jobhunter.util.error;
...
import vn.tunguyen.jobhunter.domain.RestResponse;
...
public class GlobalException {
    ...
    public ResponseEntity<RestResponse<Object>> handleIdException(Exception ex) {
        ...
        res.setMessage("Invalid credentials or ID issue.");
    ...
    public ResponseEntity<RestResponse<Object>> handleNotFoundException(NoResourceFoundException ex) {
        ...
        rest.setStatusCode(HttpStatus.NOT_FOUND.value());
        rest.setError(ex.getMessage());
        rest.setMessage("404 Not Found. URL may not exist...");
